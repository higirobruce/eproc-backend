...
exports.generateTenderNumber = void 0;
const tenders_1 = require("../models/tenders");
const generateTenderNumber = () => __awaiter(void 0, void 0, void 0, function* () {
    // Get the last saved document
    const lastDocument = yield tenders_1.TenderModel.findOne().sort({ number: -1 });
...
exports.generateTenderNumber = generateTenderNumber;
