...
exports.poRouter.post("/", (req, response) => __awaiter(void 0, void 0, void 0, function* () {
    let { vendor, tender, request, createdBy, sections, items, status, deliveryProgress, B1Data, } = req.body;
    let CardCode;
    yield (0, b1_1.getBusinessPartnerByName)(B1Data === null || B1Data === void 0 ? void 0 : B1Data.CardName).then((res) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        if ((bp === null || bp === void 0 ? void 0 : bp.length) >= 1) {
            ...
            yield (0, purchaseOrders_2.savePOInB1)(CardCode, B1Data.DocType, B1Data.DocumentLines);
            let number = yield (0, purchaseOrders_3.generatePONumber)();
            let tenderToCreate = new purchaseOrders_1.PurchaseOrder(number, vendor, tender, request, createdBy, sections, items, status, deliveryProgress);
