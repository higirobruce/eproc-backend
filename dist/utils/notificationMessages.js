...
exports.tenderPublished = exports.prRejected = exports.prSubmitedForApproval = void 0;
const prSubmitedForApproval = (prId) => {
    return {
...
exports.prSubmitedForApproval = prSubmitedForApproval;
const prRejected = (prId) => {
    return {
...
exports.prRejected = prRejected;
const tenderPublished = (tenderId) => {
    return {
...
exports.tenderPublished = tenderPublished;
